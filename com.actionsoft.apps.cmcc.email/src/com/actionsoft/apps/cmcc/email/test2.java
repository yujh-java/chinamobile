...
public class test2 {
	...
	*/
		...
		String title = "项目催办任务提醒";
		test.sendEmail("1654425379@qq.com",title , "项目催办任务提醒");
	}
	public void sendShortMsg(String mobile,String mobileContext) {
		/*try {
			mobileContext = URLEncoder.encode(mobileContext, "utf-8");
		} catch (UnsupportedEncodingException e1) {
			e1.printStackTrace();
		}*/
		System.out.println("mobileContext=="+mobileContext);
		/**
		 * 发送短信
		 */
		JSONObject obj = new JSONObject();
	...
	public void sendEmail(String email,String title,String emailContext){
