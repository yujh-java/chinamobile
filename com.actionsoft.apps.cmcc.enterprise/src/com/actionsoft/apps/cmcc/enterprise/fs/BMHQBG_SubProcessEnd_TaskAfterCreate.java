 ...
 * @date 20190424
 */
public class BMHQBG_SubProcessEnd_TaskAfterCreate extends ExecuteListener implements ExecuteListenerInterface{
	...
	public void execute(ProcessExecutionContext param) throws Exception {
		...
		if (task_acticityId.equals(QbActivityIdConst.ysbmjkr)) {// 子流程最后一个节点
			acticityId = QbActivityIdConst.qtyfjkr;// 主流程配合部所会签节点
		} 
		...
		try{
			...
			List<BO> list = SDK.getBOAPI().query("BO_ACT_CMCC_PROCESSHANDLE").addQuery("PROCESSID = ", parentProcessId)
					.addQuery("ACTIVITYID = ", "obj_c86ca862ad800001cdc01e401d421188").connection(conn).list();//主流程配合部所会签节点
