 ...
 * @date 20190709
 */
public class BMHQSY_SubProcessEnd_TaskAfterCreate extends ExecuteListener implements ExecuteListenerInterface{
	...
	public void execute(ProcessExecutionContext param) throws Exception {
		...
		try{
			...
			List<BO> list = SDK.getBOAPI().query("BO_ACT_CMCC_PROCESSHANDLE").addQuery("PROCESSID = ", parentProcessId)
					.addQuery("ACTIVITYID = ", "obj_c883809dcc60000198da193f8f60d9f0").connection(conn).list();//主流程配合部所会签节点
