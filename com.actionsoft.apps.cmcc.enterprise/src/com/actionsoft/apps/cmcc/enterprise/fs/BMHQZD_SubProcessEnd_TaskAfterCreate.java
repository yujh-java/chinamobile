 ...
 * @date 20190424
 */
public class BMHQZD_SubProcessEnd_TaskAfterCreate extends ExecuteListener implements ExecuteListenerInterface{
	...
	public void execute(ProcessExecutionContext param) throws Exception {
		...
		if (task_acticityId.equals(QbActivityIdConst.ysbmjkr)) {// 子流程最后一个节点
			acticityId = QbActivityIdConst.qtyfjkr;// 主流程中配合部所会签节点
		} 
		...
		try{
			...
			List<BO> list = SDK.getBOAPI().query("BO_ACT_CMCC_PROCESSHANDLE").addQuery("PROCESSID = ", parentProcessId)
					.addQuery("ACTIVITYID = ", "obj_c86bc3a4c8800001f9b16d901b911077").connection(conn).list();//主流程中配合部所会签节点
