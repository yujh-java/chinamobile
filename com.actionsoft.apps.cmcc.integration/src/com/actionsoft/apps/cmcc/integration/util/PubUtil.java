...
public class PubUtil {
	 ...
	 * @return
	 */
	public static String getTaskOfWorking(Connection conn,String userid,String startTime,String endTime,String processType,String taskTitle,int start_sizte,int end_size,String processApp,String IOSID){
...
//			taskQueryApi = SDK.getTaskQueryAPI().userTaskOfWorking().connection(conn).target(userid).addQuery("TASKSTATE != ", "4");
		...
		return getTaskresult(conn,userid,startTime,endTime,processType,taskTitle,taskQueryApi,start_sizte,end_size,processApp);
	}
	/**
	 * 根据用户账号，查询已办任务
	 * @param userid
	 * @param wfhTask 用于判断是否为已办或已阅
	 * @return
	 */
	public static String getTaskComplete(Connection conn,String userid,String startTime,String endTime,String processType,String taskTitle,int start_sizte,int end_size,String processApp,String IOSID,String wfhTask){
		...
		return getHisTaskresult(conn,userid,startTime,endTime,processType,taskTitle,hisTaskQueryApi,start_sizte,end_size,processApp,wfhTask,IOSID);
	}
	/**
	 * 根据用户账号，查询已阅任务
	 * @param userid
	 * @return
	 */
	public static String getTaskNotification(Connection conn,String userid,String startTime,String endTime,String processType,String taskTitle,int start_sizte,int end_size,String processApp,String IOSID,String wfhTask){
		HistoryTaskQueryAPI hisTaskQueryApi = null;
		if(UtilString.isEmpty(userid)){
	 ...
	 * @return
	 */
	public static String getTaskOfNotification(Connection conn,String userid,String startTime,String endTime,String processType,String taskTitle,int start_sizte,int end_size,String processApp,String IOSID){
		TaskQueryAPI taskQueryApi = null;
		if(UtilString.isEmpty(userid)){
	 ...
	 * @return
	 */
	public static String getHisTaskresult(Connection conn,String userid,String startTime,String endTime,String processType,String taskTitle,HistoryTaskQueryAPI taskQueryApi,int start_sizte,int end_size,String processApp,String wfhTask,String IOSID){
		...
		if(!UtilString.isEmpty(startTime)){
			Date startDate = null;
			Date parse = UtilDate.parse(startTime,"yyyy-MM-dd HH:mm:ss");
			try {
				startDate = sdf.parse(startTime);
			} catch (ParseException e) {
				e.printStackTrace(System.err);
		...
		//过滤历史任务
		List<Map<String,Object>> newlist = Filterlistutil.filterHisList(list,listJqlHisTask);
	 ...
	 * @return
	 */
	public static String getTaskresult(Connection conn,String userid,String startTime,String endTime,String processType,String taskTitle,TaskQueryAPI taskQueryApi,int start_sizte,int end_size,String processApp){
		JSONObject jsonResult = new JSONObject();
		jsonResult.put("isSuccess", false);
		jsonResult.put("msg", "");
		jsonResult.put("size", 0);
...
//							}
	 ...
	 * 获取流程所有经办人账号ID
	 * @author chenxf
	 * @date   2018年4月25日 上午9:51:19
	 * @param processid
	 * @return
	 */
	public static String getPersonUID(String processid) {
...
//		return namesbf.toString();
	...
	public static String getNoteIdName(String processDefid, String activityId) {
		...
		if(null!=processDefinition){
			activityName = processDefinition.findProcessNode(activityId).getName();
		}*/
		UserTaskModel taskModel  = UserTaskDefUtil.getModel(processDefid, activityId);
		String activityName = "";
		if (taskModel != null) {
		...
		//String activityName=SDK.getRepositoryAPI().getActivityModel(processDefid, activityId).getName();
		return activityName;
	}
}
