...
/** 
* @author 作者 E-mail: 
* @version 创建时间：2019年4月25日 下午4:55:59 
* 类说明  自动办理任务并保存办理人信息——科技委节点
*/
public class SaveProcessUserEvent extends ExecuteListener implements ExecuteListenerInterface{
	public String getDescription() {
		return "自动办理任务并保存办理人信息——科技委节点";
	}
