 ...
 * 部门内所有人
 */
public class DepartmentUsersForDeptEvent implements AddressUIFilterInterface {
	
	private String searchDepartmentId = StandardizationConstant.DEPT_ALL;
	@Override
	...
	public boolean addressUIFlexUserFilter(UserContext uc, UserModel model, AdvancedAddressModel advancedAddressModel) {
		if(model.getDepartmentId().equals(searchDepartmentId)){
			return false;
		}
		return true;
	}
