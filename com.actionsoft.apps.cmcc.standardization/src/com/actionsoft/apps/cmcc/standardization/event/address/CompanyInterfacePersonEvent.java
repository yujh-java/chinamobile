...
* 类说明  单位接口人角色
*/
public class CompanyInterfacePersonEvent implements AddressUIFilterInterface{	
	...
	public boolean addressUIFlexUserFilter(UserContext uc, UserModel model, AdvancedAddressModel arg2) {
		...
		if(UtilString.isEmpty(roleId)){
			roleId =DBSql.getString("SELECT ID FROM ORGROLE WHERE ROLENAME = ?", new Object[]{StandardizationConstant.COMPANY_INTERFACE_PERSON});
		}
