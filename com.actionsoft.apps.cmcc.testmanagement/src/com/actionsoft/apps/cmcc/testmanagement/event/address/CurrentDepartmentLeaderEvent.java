...
* 部所领导节点人员过滤
*/
public class CurrentDepartmentLeaderEvent implements AddressUIFilterInterface{
	@Override
	public boolean addressUIFlexDepartmentFilter(UserContext uc,
			DepartmentModel model, AdvancedAddressModel advancedAddressModel) {
		//获得流程创建人的全路径
		String userid = uc.getUID();//获取当前办理人
	...
	public boolean addressUIFlexUserFilter(UserContext uc, UserModel model,
		...
		if(!TestManagementConst.user_leave3.equals("3") || !"3".equals(kzzd)){
			return false;
		}
		return true;
	}
