package com.actionsoft.apps.cmcc.labslx;
/**
 * 研究院立项流程
 * 提报节点办理后记录提交时间
 * 记录需求部门
...
public class LabsLx_TaskAfterComplete_step01 extends ExecuteListener implements ExecuteListenerInterface {
	public String getDescription() {
		return "研究院立项流程创建后，状态信息回写";
	}
