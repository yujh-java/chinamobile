...
public class LX_SubProcessEnd_TaskAfterCreate extends ExecuteListener implements ExecuteListenerInterface {
	...
	public void execute(ProcessExecutionContext param) throws Exception {
		...
		String acticityId = "";
		if (task_acticityId.equals(LxActivityIdConst.sub_qtyfjkr)) {// 配合研发机构子流程
			acticityId = LxActivityIdConst.qtyfjkr;// 牵头研发机构项目接口人处理
		} else if (task_acticityId.equals(LxActivityIdConst.sub_zbyfxmjkr)) {// 需求部门子流程
			acticityId = LxActivityIdConst.zbyfxmjkr;// 总部研发项目接口人处理
		}
