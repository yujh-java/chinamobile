...
public class UnplanedProject_TaskAfterComplete_step01 extends ExecuteListener implements ExecuteListenerInterface {
	public String getDescription() {
		return "自立、国拨计划外项目流程创建后，状态信息回写";
	}
	...
	public void execute(ProcessExecutionContext param) throws Exception {
		...
		if (list != null && list.size() > 0) {
			...
			String PROCESSTYPE = DBSql.getString(conn,"SELECT PROCESSTYPE FROM BO_ACT_PROCESS_DATA WHERE PROCESSDEFNID = ?",
