 ...
 *20190610
 */
public class YB_PendingState_TaskAfterComplete extends ExecuteListener implements
ExecuteListenerInterface{
	...
	public void execute(ProcessExecutionContext param) throws Exception {
		...
		/*if(taskState == 1 || taskState == 4||taskState==11){
			...
			if(activityID.equals(CmccCommon.sub_bpxqbmhq)){
				//企标复审需求部门子流程:企标管理节点,这里是写入子流程标题的地方
