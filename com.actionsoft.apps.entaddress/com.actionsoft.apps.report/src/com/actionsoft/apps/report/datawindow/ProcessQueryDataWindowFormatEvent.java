...
/**
 * @author w13021111134 流程查询表格数据格式化
 *
 */
public class ProcessQueryDataWindowFormatEvent implements DataWindowFormatDataEventInterface {
	public void formatData(UserContext usercontext, JSONArray datas) {
		for (Object datao : datas) {
			...
			try {
				...
				data.put("TIMES" + DataSourceEngine.AWS_DW_FIXED_CLOMUN_SHOW_RULE_SUFFIX, ProcessUtil.getCostTime(createTime, processEndTime));
	 ...
	 * @throws ParseException 
	  */
	 public String formatGridExport(UserContext me, ResultSet rs, Column colModel, String fieldId) throws SQLException, ParseException {
	   ...
	   if (fieldId.equals("ACTIVITYDEFID")) { // 如果名字是ACTIVITYDEFID
			...
			String processid = rs.getString("PROCESSINSTID");  ;//流程实例ID PROCESSINSTID
